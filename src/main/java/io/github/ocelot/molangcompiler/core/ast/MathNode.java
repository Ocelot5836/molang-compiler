...
import io.github.ocelot.molangcompiler.core.MolangUtil;
    ...
    public void writeBytecode(MethodNode method, MolangBytecodeEnvironment env, @Nullable Label breakLabel, @Nullable Label continueLabel) throws MolangException {
        switch (this.function) {
            ...
            case CLAMP -> {
                ...
                method.visitMethodInsn(Opcodes.INVOKESTATIC, "io/github/ocelot/molangcompiler/core/MolangUtil", "clamp", "(FFF)F", false);
            }
            case DIE_ROLL -> {
                this.arguments[0].writeBytecode(method, env, breakLabel, continueLabel);
                method.visitInsn(Opcodes.F2I);
            ...
            case HERMITE_BLEND -> {
                this.arguments[0].writeBytecode(method, env, breakLabel, continueLabel);
                method.visitMethodInsn(Opcodes.INVOKESTATIC, "io/github/ocelot/molangcompiler/core/MolangUtil", "hermiteBlend", "(F)F", false);
            }
            case LERP -> {
                this.arguments[0].writeBytecode(method, env, breakLabel, continueLabel);
                this.arguments[1].writeBytecode(method, env, breakLabel, continueLabel);
                this.arguments[2].writeBytecode(method, env, breakLabel, continueLabel);
                method.visitMethodInsn(Opcodes.INVOKESTATIC, "io/github/ocelot/molangcompiler/core/MolangUtil", "lerp", "(FFF)F", false);
            }
            case LERPROTATE -> {
                this.arguments[0].writeBytecode(method, env, breakLabel, continueLabel);
                this.arguments[1].writeBytecode(method, env, breakLabel, continueLabel);
                this.arguments[2].writeBytecode(method, env, breakLabel, continueLabel);
                method.visitMethodInsn(Opcodes.INVOKESTATIC, "io/github/ocelot/molangcompiler/core/MolangUtil", "lerpRotate", "(FFF)F", false);
            }
            case MIN_ANGLE -> {
                this.arguments[0].writeBytecode(method, env, breakLabel, continueLabel);
                method.visitMethodInsn(Opcodes.INVOKESTATIC, "io/github/ocelot/molangcompiler/core/MolangUtil", "wrapDegrees", "(F)F", false);
            }
            case RANDOM -> {
                this.arguments[0].writeBytecode(method, env, breakLabel, continueLabel);
                this.arguments[1].writeBytecode(method, env, breakLabel, continueLabel);
                method.visitMethodInsn(Opcodes.INVOKESTATIC, "io/github/ocelot/molangcompiler/core/MolangUtil", "random", "(FF)F", false);
            }
            case RANDOM_INTEGER -> {
                this.arguments[0].writeBytecode(method, env, breakLabel, continueLabel);
                method.visitInsn(Opcodes.F2I);
